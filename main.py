...
def kume_islemleri():
    ...
    try:
        ...
        # Listeleri çekip kümeye çeviriyoruz
        ...
        # 1. BİRLEŞİM (İki kümedeki tüm elemanlar)
        ...
        # 3. FARK (Birinde olup diğerinde olmayanlar)
        baslangic = time.perf_counter()
        fark1 = kume1.difference(kume2) # Küme 1'de olup Küme 2'de olmayanlar
        bitis = time.perf_counter()
